...
\begin{figure}[ht]
    ...
    \label{fig:figure2}
    \end{figure}
% Figure2 Vymyslet, jak to udělat s tou tmavou čárou v pravém obrázku a sjednotit čísla na y osách, aby to byla procenta. Sjednotit popisky na x ose.
...
\begin{figure}[ht]
    ...
    \label{fig:figure3}
    \end{figure}
% Figure3 Zkusit to dát od 1 do 10 a zmenšit jako ostatní obrázky s RIN. Sjednotit popisky na x ose.
...
\begin{figure}[ht]
    ...
    \label{fig:figure6}
    \end{figure}
% Figure6 Sjednotit popisky na x ose, je jinde napsáno v popiskách normalizováno? Sjednotit to, aby na obou y osách bylo ty ty samé čísla.    
