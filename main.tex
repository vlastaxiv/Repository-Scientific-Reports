...
\label{fig:figure1}
\end{figure}
% Figure1 ještě prověřit, jestli je vše updatované, pro EDTA beru pouze S.
...
\begin{figure}[ht]
    ...
    \label{fig:figure2}
    \end{figure}
% Figure2, změnit popisek na ose x a vynechat všechny downregulované M. Zrušit nadpis grafu a do x ještě přidat EDTA tubes
...
\begin{figure}[ht]
    ...
    \label{fig:figure3}
    \end{figure}
% Figure3. Asi se nedělají nadpisy grafů, dát do osy x, že je to in EDTA tubes, přepsat popisek obrázku
