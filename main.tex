...
\label{fig:figure1}
\end{figure}
% Figure1 ještě prověřit, jestli tam bude vše a ještě předělat. Sjednotit popisky na x ose
...
\begin{figure}[ht]
    ...
    \label{fig:figure2}
    \end{figure}
% Figure2 pozor na popis procent, předělat a taky musíbýt T2-TO ebo delta T2
...
\begin{figure}[ht]
    ...
    \label{fig:figure3}
    \end{figure}
% Figure3 Kombinace EDTA a PAX, chybí ještě dodělat detailnější popis jako the percent change in gene expression, where T0T0 is set to 0% as a baseline for comparison.
